...
@section('pageTitle', 'سند صرف')

@section('content')
    <h1 class="h3 mb-4 text-gray-800 main-title"> سند صرف </h1>
    <div class="container">

	<form action="{{ route('receipt-payment-add') }}" class="form-admin" id="receipt_submit" method="post">
     	{{ csrf_field() }}
		...
		<div class="col-12 text-center receipt-number"> {{$invoice_num ?? 'P00001'}} سند صرف</div>
