...
@section('styles')
<link rel="stylesheet" href="{{ URL::asset('css/manager/employee.css') }}">
@stop
        ...
        <div class="col-lg-9 main-panel">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">اضافة موظف</h6>
                </div>
                <div class="card-body">
                <form action="{{ route('employee-add') }}" class="form-admin" id="addEmployeeForm" method="post">
                        {{ csrf_field() }}                 
                        <div class="row col-md-12 table_direction">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <label for="email" class="lbl col-md-12">نوع الراتب</label>
                                    <div class="form-check form-check-inline salary-block">
                                            <input class="form-check-input" type="radio" name="salary_type" id="day" value="1" checked>
                                            <label class="form-check-label lbl_salary" for="day">
                                                يومي
                                            </label>
                                            <input class="form-check-input" type="radio" name="salary_type" id="month" value="2" >
                                            <label class="form-check-label lbl_salary" for="month">
                                                شهري
                                            </label>
                                            <input class="form-check-input" type="radio" name="salary_type" id="hour" value="3" >
                                            <label class="form-check-label lbl_salary" for="hour">
                                                حسب الساعة
                                            </label>
                                        </div>
                                    </div>
