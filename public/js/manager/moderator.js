var actionsCell = function(id, type, row) {
    var action_element = 
            ...
            + '<a href="/manager/moderator/edit/' + row.id + '" class="btn btn-info btn-circle">'
            + '<i class="fas fa-pen-alt"></i></a>&nbsp;&nbsp'
            + '<a href="/manager/moderator/' + row.id + '" class="btn btn-primary btn-circle">'
...
$(document).ready(function() {
    $('#dataTables_moderator').DataTable( {
        "pageLength": 10,
        "info":     false,
        "responsive": true,
        "processing": true,
